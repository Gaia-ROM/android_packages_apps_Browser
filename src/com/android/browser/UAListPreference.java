/* All credits goes to AdamG (github.com/adamg-xda) */
...
public class UAListPreference extends ListPreference {
    private Context mContext;
    private String mUserAgent;
    private boolean mDialogShowing;
    private EditText mUserAgentCustom;
 
    public UAListPreference(Context context) {
        super(context);
        mContext = context;
    }
 
    public UAListPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        if (positiveResult) {
            ...
            if (Integer.parseInt(prefs.getString("web_ua", "0")) == 4) {
                showDialog();
            }
        }
    }
    ...
    private void showDialog() {
        ...
        View v = inflater.inflate(R.layout.custom_ua_dialog, null);
        ...
        new AlertDialog.Builder(mContext).setIcon(
                ...
                R.string.pref_ua_title).setView(v)
